...
class RobotSensors
{
 ...
 public:
    ...
    RobotSensors(ISensorEncoder *_a,
                 ISensorEncoder *_b,
                 ISensorEncoder *_c,
                 ISensorEncoder *_d,
...
private:
    ...
    ISensorEncoder *enc_a;
    ISensorEncoder *enc_b;
    ISensorEncoder *enc_c;
    ISensorEncoder *enc_d;

    ISensorOrientation2 *mOrientationSensor;
...
public:
  ...
  VehicleRobotCar(IRigidBody *base ,
    ...
    {
        mVehicleRobot = new RobotSensors(new ISensorEncoder(Wheel_HingeJoint0),
                                         new ISensorEncoder(Wheel_HingeJoint1),
                                         new ISensorEncoder(Wheel_HingeJoint2),
                                         new ISensorEncoder(Wheel_HingeJoint3),
                                         base);
