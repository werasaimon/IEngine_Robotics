#ifndef ISENSORORIENTATION_H
#define ISENSORORIENTATION_H
...
public:
    ...
    ISensorOrientation2(IRigidBody *_PhysicsBody=nullptr , scalar _time_step=1.0)
...
public:
    ...
    ISensorOrientation(IRigidBody *_PhysicsBody=nullptr , scalar _time_step=1.0)
    : m_PhysicsBody(_PhysicsBody) ,
      m_TimeStep(_time_step)
    {
