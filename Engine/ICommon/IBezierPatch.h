#ifndef IBEZIERPATCH_H
#define IBEZIERPATCH_H

#include "IBernsteinPolynomial.h"
...
template <typename T> using BezierPatch2T = BezierPatch<IMath::IVector2D<T>, T>;
template <typename T> using BezierPatch3T = BezierPatch<IMath::IVector3D<T>, T>;
